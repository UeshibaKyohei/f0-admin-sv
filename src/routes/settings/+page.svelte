<script lang="ts">
	...
	const securitySettings = $state({
		...
		loginHistory: [
			{
				date: '2025-05-22T08:20:00',
				ip: '192.168.1.1',
				device: 'MacBook Pro',
				location: '東京, 日本'
			},
			{
				date: '2025-05-21T14:10:00',
				ip: '192.168.1.1',
				device: 'iPhone 16',
				location: '東京, 日本'
			},
		...
		<div class="card-body">
					...
					<div class="flex flex-col gap-8 md:flex-row">
						<div class="flex flex-col items-center md:w-1/4">
							<div class="avatar placeholder">
								<div class="bg-neutral-focus text-neutral-content w-24 rounded-full">
			...
			{#if activeTab === 'notifications'}
				<form on:submit|preventDefault={handleSubmit} class="space-y-6">
					...
					<h3 class="mb-4 text-lg font-medium">通知設定</h3>
					<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
						<div class="form-control">
							<label class="label cursor-pointer justify-start gap-3">
								<input
			...
			{#if activeTab === 'security'}
				<div class="space-y-8">
					<div>
						<h3 class="mb-4 text-lg font-medium">アカウントセキュリティ</h3>
						<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
							<div class="form-control">
								<label class="label cursor-pointer justify-start gap-3">
									<input
								...
								<p class="text-base-content/60 mt-1 ml-11 text-sm">
					...
					<div>
						<h3 class="mb-4 text-lg font-medium">ログイン履歴</h3>
