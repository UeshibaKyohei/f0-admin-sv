...
<div class="container mx-auto space-y-8 px-4 py-8">
	...
	<div class="text-center">
		<h1 class="mb-4 text-4xl font-bold">🎨 テーマ設定</h1>
		<p class="text-base-content/70 mb-6 text-lg">
			お好みのテーマを選択してサイトの外観をカスタマイズできます
		</p>

		<!-- 現在のテーマ情報 -->
		<div class="card bg-base-200 mx-auto max-w-md shadow-lg">
				...
				<div class="my-4 flex items-center justify-center gap-3">
					...
					<div class="flex gap-1">
						{#each Object.values(themeInfo.colors) as color}
							<div
								class="border-base-content/20 h-6 w-6 rounded-full border-2"
								style="background: {color}"
							></div>
						{/each}
					</div>
					<div>
						<div class="text-lg font-bold">{themeInfo.displayName}</div>
				...
				<div class="form-control">
					...
					<div class="flex gap-2">
						...
						<div class="dropdown dropdown-end">
							<div tabindex="0" role="button" class="btn btn-neutral btn-sm">⚙️ 設定</div>
			...
			<div class="card-body">
				...
				<div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
					{#each favoriteThemes as themeName}
						...
						>
							<div class="mb-1 text-xs font-medium">{getThemeDisplayName(themeName)}</div>
							<div class="flex gap-1">
							...
							{#if currentTheme === themeName}
								<div class="mt-1 text-xs opacity-70">適用中</div>
							{/if}
						</button>
					{/each}
				</div>
		...
		<div class="card-body">
					...
					<div class="card bg-base-100 shadow-md transition-shadow hover:shadow-lg">
						<div class="card-body p-4">
							...
							<div class="mb-3 flex items-start justify-between">
								<div>
									<h3 class="text-sm font-bold">{getThemeDisplayName(themeName)}</h3>
							...
							<div class="mb-3 grid grid-cols-4 gap-1">
								{#each Object.values(themeColors[themeName] || themeColors.light) as color}
									<div
										class="border-base-content/20 aspect-square w-full rounded border"
										style="background: {color}"
										title={color}
									></div>
								{/each}
							...
							<!-- プレビューサンプル -->
							<div class="mb-3 space-y-2" data-theme={themeName}>
								<div class="flex gap-1">
			...
			{#if filteredThemes.length === 0}
				<div class="py-8 text-center">
					...
					<h3 class="mb-2 text-lg font-bold">テーマが見つかりません</h3>
	...
	<div class="card bg-base-200 shadow-lg">
		<div class="card-body">
			...
			<!-- ボタンプレビュー -->
			<div class="mb-6">
				<h3 class="mb-3 text-lg font-semibold">ボタン</h3>
			...
			<!-- アラートプレビュー -->
			<div class="mb-6">
				<h3 class="mb-3 text-lg font-semibold">アラート</h3>
				<div class="space-y-2">
			...
			<!-- フォームプレビュー -->
			<div class="mb-6">
				<h3 class="mb-3 text-lg font-semibold">フォーム要素</h3>
			...
			<!-- プログレスとレーティング -->
			<div class="mb-6">
				<h3 class="mb-3 text-lg font-semibold">その他のコンポーネント</h3>
				<div class="space-y-4">
					<div>
						<div class="mb-1 text-sm font-medium">プログレスバー</div>
					...
					<div>
						<div class="mb-2 text-sm font-medium">レーティング</div>
						<div class="rating">
					...
					<div>
						<div class="mb-2 text-sm font-medium">バッジ</div>
						<div class="flex flex-wrap gap-2">
	...
	<div class="card bg-base-200 shadow-lg">
		<div class="card-body">
			...
			<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
				<div>
					<h3 class="mb-2 font-bold">✨ 主な機能</h3>
				...
				<div>
					<h3 class="mb-2 font-bold">🔧 技術仕様</h3>
					<ul class="list-inside list-disc space-y-1 text-sm">
