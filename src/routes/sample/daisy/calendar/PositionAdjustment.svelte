...
<div class="space-y-8">
  ...
  <div class="text-center">
    <h2 class="text-3xl font-bold mb-4">📍 カレンダー表示位置の調整</h2>
    <p class="text-base-content/70">
      Pikadayのpositionオプションを使った表示位置のコントロール
    </p>
  </div>
    ...
    <div class="card-body">
      ...
      <div class="bg-base-200 p-6 rounded-lg mb-4">
        <div class="alert alert-info mb-4">
          ...
          <span class="text-sm">画面右端に配置されたinputは、カレンダーが画面外にはみ出さないよう自動的に位置が調整されます</span>
        </div>
    ...
    <div class="card-body">
      ...
      <div class="alert alert-warning mb-4">
        ...
        <div>
          ...
          <p class="text-sm">containerオプションを使用する場合、親要素にposition: relativeが必要です</p>
        </div>
      </div>
