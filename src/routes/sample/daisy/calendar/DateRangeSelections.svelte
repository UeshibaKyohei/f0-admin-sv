...
<div class="space-y-8">
  ...
  <div class="card bg-base-100 shadow-xl">
    <div class="card-body">
      ...
      <div class="bg-base-200 p-6 rounded-lg mb-4">
        <h4 class="font-semibold mb-3">デモ</h4>
  ...
  <div class="card bg-base-100 shadow-xl">
    <div class="card-body">
      ...
      <!-- デモ -->
      <div class="bg-base-200 p-6 rounded-lg mb-4">
        <h4 class="font-semibold mb-3">デモ（3ヶ月先まで・最大30日間）</h4>
        <div class="flex gap-4 flex-wrap">
          <div class="form-control">
            <label class="label">
              <span class="label-text">開始日</span>
  ...
  <div class="card bg-primary/10 border-2 border-primary/20">
    <div class="card-body">
      ...
      <ul class="space-y-2 text-sm">
        ...
        <li class="flex items-start">
          <span class="text-primary mr-2">✓</span>
          <span>期間の長さや選択可能な日付範囲に制限を設ける場合は、視覚的にフィードバックを提供</span>
        </li>
        <li class="flex items-start">
          <span class="text-primary mr-2">✓</span>
...
>
  <calendar-date 
    class="cally p-4"
    onchange={handleCallyStartChange}
    value={callyStartDate}
  >
