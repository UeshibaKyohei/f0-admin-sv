...
<div class="space-y-8" id="basic">
  ...
  <div class="text-center">
    <h2 class="text-3xl font-bold mb-4">📅 基本的な実装例</h2>
    ...
    <div class="card-body">
      <div class="flex items-center justify-between mb-4">
        ...
        <button 
          ...
          on:click={() => copyToClipboard(setupCode, 'setup')}
        >
      ...
      <div class="alert alert-success mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="stroke-current shrink-0 h-6 w-6"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
        <div>
          <p class="font-bold">DaisyUI v5の公式サポート</p>
          <p class="text-sm">DaisyUIがPikadayとCallyのスタイルを公式にサポートしているため、追加のCSS読み込みは不要です。</p>
        </div>
      </div>
    ...
    <div class="card-body">
      ...
      <div class="alert alert-warning mb-4">
        ...
        <div>
          ...
          <p class="text-sm">formatオプションはmoment.js専用です。moment.jsは2020年9月にメンテナンスモードとなり、新規使用は非推奨です。</p>
          <p class="text-sm mt-1">現在は<code class="text-primary">toString('YYYY-MM-DD')</code>メソッドの使用が推奨されています。</p>
        </div>
      </div>
  ...
  <div class="card bg-base-100 shadow-xl">
    <div class="card-body">
      ...
      <div class="bg-base-200 p-6 rounded-lg mb-4">
        <div class="form-control max-w-xs relative">
          <label class="label">
            <span class="label-text">日付を選択</span>
          </label>
          <input 
      ...
      <div class="bg-base-200 p-6 rounded-lg mb-4">
        <div class="alert alert-warning mb-4">
          ...
          <div>
            ...
            <p class="text-sm font-mono mt-1">&lt;script type="module" src="https://unpkg.com/cally"&gt;&lt;/script&gt;</p>
          </div>
        </div>
  ...
  <div class="card bg-base-100 shadow-xl">
    <div class="card-body">
      ...
      <div class="alert alert-warning mt-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
        <span>Popover APIは比較的新しい機能です。古いブラウザでは代替実装が必要な場合があります。</span>
      </div>
    </div>
  </div>
</div>