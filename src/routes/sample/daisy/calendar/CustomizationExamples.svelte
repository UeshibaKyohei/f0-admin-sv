...
<div class="space-y-8">
	...
	<div class="text-center">
		<h2 class="text-primary mb-2 text-3xl font-bold">カスタマイズ例</h2>
			...
			<div class="space-y-4">
				<div>
					...
					<div class="grid grid-cols-2 gap-2 text-sm">
						<div>
							<p class="mb-1 font-bold">週末</p>
							<ul class="text-base-content/70 list-inside list-disc">
								<li>土曜日</li>
								<li>日曜日</li>
							</ul>
						</div>
						<div>
							<p class="mb-1 font-bold">会社休業日（2025年）</p>
							<ul class="text-base-content/70 list-inside list-disc">
								<li>8/13-15（夏季休暇）</li>
								<li>12/29-31（年末休暇）</li>
							</ul>
			...
			<div class="space-y-4">
				<div>
					...
					<div class="alert mt-4">
						...
						<div>
							<div class="text-xs">
								<span class="font-bold text-red-600">■</span> 日曜日・祝日　
								<span class="font-bold text-blue-600">■</span> 土曜日　
								<span class="inline-block rounded bg-[#ffe4e1] px-2 text-xs font-bold text-[#d00]"
									>祝日背景</span
								>
							</div>
						</div>
					...
					<div class="mt-4">
						<p class="mb-2 text-sm font-bold">実装のポイント：</p>
	...
	<div class="card bg-primary/10 border-primary/20 border-2">
		<div class="card-body">
			...
			<div class="grid gap-4 md:grid-cols-2">
				<div>
					<h4 class="mb-2 font-bold">Pikadayの基本設定</h4>
				...
				<div>
					<h4 class="mb-2 font-bold">スタイリングのテクニック</h4>
					<ul class="space-y-1 text-sm">
