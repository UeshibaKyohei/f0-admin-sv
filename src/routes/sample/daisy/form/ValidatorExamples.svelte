...
<div class="space-y-6">
	...
	<div class="alert alert-info">
		...
		<div>
			...
			<p class="text-sm">
				The <code class="badge badge-sm">validator</code> class automatically applies error or success
				styling based on HTML5 validation attributes. Invalid inputs show error styles, valid inputs
				show success styles.
			</p>
		</div>
	</div>
	...
	<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
		...
		<div class="form-control">
			...
			<input type="email" class="input validator" value="invalid-email" required />
		...
		<div class="form-control">
			...
			<input type="email" class="input validator" value="valid@email.com" required />
...
<input type="checkbox" class="toggle validator" required />`}</code
			></pre>
	</div>
</div>
