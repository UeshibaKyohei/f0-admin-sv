	...
	<div class="border rounded-lg p-6 bg-base-50">
		...
		<div class="grid md:grid-cols-2 gap-6">
			<div class="space-y-4">
				<div class="form-control">
					...
					{#if selectedFiles && selectedFiles.length > 0}
						<label class="label">
							<span class="label-text-alt">Selected: {selectedFiles[0].name} ({formatFileSize(selectedFiles[0].size)})</span>
						</label>
					{/if}
				</div>
			...
			<div class="mockup-code text-sm">
				<pre><code>&lt;input type="file" class="file-input" onchange={'{handleFileChange}'} /&gt;
...
&lt;!-- Disabled --&gt;
&lt;input type="file" class="file-input" disabled /&gt;</code></pre>
			</div>
		</div>
	</div>
	...
	<div class="border rounded-lg p-6 bg-base-50">
		...
		<div class="grid md:grid-cols-2 gap-6">
			...
			<div class="mockup-code text-sm">
				<pre><code>&lt;input type="file" class="file-input file-input-xs" /&gt;
&lt;input type="file" class="file-input file-input-sm" /&gt;
&lt;input type="file" class="file-input file-input-md" /&gt;
&lt;input type="file" class="file-input file-input-lg" /&gt;</code></pre>
			</div>
		</div>
	</div>
	...
	<div class="border rounded-lg p-6 bg-base-50">
		...
		<div class="grid md:grid-cols-2 gap-6">
			...
			<div class="mockup-code text-sm">
				<pre><code>&lt;input type="file" class="file-input file-input-primary" /&gt;
&lt;input type="file" class="file-input file-input-secondary" /&gt;
&lt;input type="file" class="file-input file-input-accent" /&gt;
&lt;input type="file" class="file-input file-input-success" /&gt;
&lt;input type="file" class="file-input file-input-warning" /&gt;
&lt;input type="file" class="file-input file-input-error" /&gt;</code></pre>
			</div>
		</div>
	</div>
...
&lt;/fieldset&gt;</code></pre>
	...
	<div class="border rounded-lg p-6 bg-base-50">
		...
		<div class="alert alert-info mb-4">
			...
			<span>These are UI design samples. Drag & drop and preview functionality require additional JavaScript implementation.</span>
		</div>
		<div class="grid md:grid-cols-2 gap-6">
			<div class="space-y-4">
				...
				<div class="form-control w-full">
					...
					<label class="label">
						<span class="label-text-alt">⚠️ UI sample - drag & drop requires custom JS implementation</span>
					</label>
				</div>
				...
				<div class="form-control">
					...
					<div class="flex gap-4 items-start">
						...
						<div class="w-20 h-20 border-2 border-dashed border-base-300 rounded-lg flex items-center justify-center text-xs text-base-content/50 bg-base-100">
					...
					<label class="label">
						<span class="label-text-alt">⚠️ Preview functionality requires custom implementation</span>
					</label>
				</div>
...
&lt;!-- Working ghost style --&gt;
&lt;input type="file" class="file-input file-input-ghost" /&gt;</code></pre>
			</div>
		</div>
	</div>
</div>