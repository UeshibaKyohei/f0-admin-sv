...
<div class="flex h-full w-full">
  <!-- 問い合わせリスト -->
  <div class="w-1/2 bg-base-100 border-r border-base-300 flex flex-col flex-shrink-0">
    <!-- ヘッダー -->
    ...
    <div class="flex-1 overflow-y-auto">
      {#each sortedInquiries as inquiry}
        ...
        <button
          class={`
            w-full p-4 border-b border-base-300 hover:bg-base-200 text-left
        ...
        >
          <div class="flex items-start justify-between mb-2">
            <div class="flex items-center gap-2">
              <div class={`badge badge-sm ${priorities[inquiry.priority || 'normal']?.color || 'badge-primary'}`}>
          ...
          <div class="font-medium mb-1">{inquiry.customerName}</div>
    ...
    {#if selectedInquiry}
      ...
      <div class="p-6 overflow-y-auto">
        ...
        <div class="mb-6">
          <div class="flex items-start justify-between mb-2">
            ...
            <div class="flex gap-2">
              <div class={`badge ${priorities[selectedInquiry.priority || 'normal']?.color || 'badge-primary'}`}>
        ...
        <div class="card bg-base-200 mb-6">
          <div class="card-body">
            <div class="text-sm font-medium mb-2">初回メッセージ:</div>
        ...
        <div class="space-y-4">
          ...
          >
            ...
            {myCapacity?.isAtCapacity ? `対応上限（${myCapacity.max}件）に達しています` : '自分が対応する'}
          </button>
          ...
          <!-- 推奨オペレーター -->
          <div>
            <div class="text-sm font-medium mb-2">推奨オペレーター:</div>
            <div class="space-y-2">
