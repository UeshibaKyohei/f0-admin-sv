...
export const batchProgress = [
  {
    ...
    currentStep: 'step6',
    progress: [
      { stepId: 'step1', status: 'completed', startTime: '2025-01-29T08:00:00', endTime: '2025-01-29T08:30:00', operator: '山田太郎' },
      { stepId: 'step2', status: 'completed', startTime: '2025-01-29T08:30:00', endTime: '2025-01-29T09:15:00', operator: '鈴木花子' },
      { stepId: 'step3', status: 'completed', startTime: '2025-01-29T09:15:00', endTime: '2025-01-29T10:15:00', operator: '田中一郎' },
      { stepId: 'step4', status: 'completed', startTime: '2025-01-29T10:15:00', endTime: '2025-01-29T13:15:00', operator: '佐藤二郎' },
      { stepId: 'step5', status: 'completed', startTime: '2025-01-29T13:45:00', endTime: '2025-01-29T15:45:00', operator: '高橋三郎' },
      { stepId: 'step6', status: 'in_progress', startTime: '2025-01-29T15:45:00', endTime: null, operator: '伊藤四郎', progress: 65 },
  ...
  },
  {
    ...
    progress: [
      { stepId: 'step1', status: 'completed', startTime: '2025-01-28T09:00:00', endTime: '2025-01-28T09:30:00', operator: '山田太郎' },
      { stepId: 'step2', status: 'completed', startTime: '2025-01-28T09:30:00', endTime: '2025-01-28T10:15:00', operator: '鈴木花子' },
      { stepId: 'step3', status: 'completed', startTime: '2025-01-28T10:15:00', endTime: '2025-01-28T11:15:00', operator: '田中一郎' },
      { stepId: 'step4', status: 'completed', startTime: '2025-01-28T11:15:00', endTime: '2025-01-28T14:15:00', operator: '佐藤二郎' },
      { stepId: 'step5', status: 'completed', startTime: '2025-01-28T14:30:00', endTime: '2025-01-28T16:30:00', operator: '高橋三郎' },
      { stepId: 'step6', status: 'completed', startTime: '2025-01-28T16:30:00', endTime: '2025-01-28T17:30:00', operator: '伊藤四郎' },
      { stepId: 'step7', status: 'completed', startTime: '2025-01-29T08:00:00', endTime: '2025-01-29T09:30:00', operator: '渡辺五郎' },
      { stepId: 'step8', status: 'completed', startTime: '2025-01-29T09:30:00', endTime: '2025-01-29T10:15:00', operator: '小林六郎' },
      { stepId: 'step9', status: 'completed', startTime: '2025-01-29T10:15:00', endTime: '2025-01-29T10:45:00', operator: '加藤七郎' },
      { stepId: 'step10', status: 'completed', startTime: '2025-01-29T10:45:00', endTime: '2025-01-29T11:00:00', operator: '木村八郎' }
    ]
  }
];
